...
public class CheckUpdate {
    ...
    public void run() {  // Call this method.
        try {
    ...
    public class UpdateCheckTask extends AsyncTask<Void, Void, Void> {  // don't need async actually
        ...
        protected Void doInBackground(Void... Void) {
            serverRequest();
            while (responseVersion == -1) ; // Wait response to set  // TODO
            return null;
        }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (responseVersion > currentAppVersion && currentAppVersion != -1.0) {
                ...
                System.out.printf("responseVersion: %f --- currentAppVersion: %f\n",
                        responseVersion,
                        currentAppVersion);
                new DownloadUpdate(context);
            } else {
